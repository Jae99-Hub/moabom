    ...
    <header className={`header${mobileSearchOpen ? ' mobile-search-open' : ''}`}>
      ...
      <div className="header-logo">
        ...
        <span
          ...
          style={{
            background: 'linear-gradient(135deg, var(--text-accent) 0%, var(--accent) 100%)',
      ...
      {/* 데스크탑 전용 검색 */}
      <div className="header-search desktop-search" data-tour="search">
        <svg className="header-search-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
          <circle cx="11" cy="11" r="8" />
          <line x1="21" y1="21" x2="16.65" y2="16.65" />
        </svg>
      ...
      <div className="header-actions">
        ...
        <button className="btn-icon header-settings-btn" onClick={openSettings} title="설정" data-tour="settings">
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
        ...
        <button className="btn-primary" onClick={() => openAddModal()} title="새 항목 추가" data-tour="add">
